    ...
    var __webpack_modules__ = {
        ...
        "../shared/browser/utils/report/index.js": (__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) => {
            ...
            var HdReport = function HdReport() {
                var _window$__PRELOAD_STA, _window$HdSdk, _window$HdSdk$shopTra, _SL_State$get, _window$HdSdk2, _window$HdSdk2$shopTr, _window$HdSdk3, _window$HdSdk4;
                _classCallCheck(this, HdReport);
                var _geEnv = (0, get_env["default"])(), APP_ENV = _geEnv.APP_ENV;
                var env = "develop" !== APP_ENV ? "product" : "";
                ...
                null === (_window$HdSdk3 = window.HdSdk) || void 0 === _window$HdSdk3 ? void 0 : _window$HdSdk3.shopTracker.use("url", (function(url, payload) {
                    ...
                    var obj = payloads.reduce((function(o, _ref) {
                        var _ref2;
                        var source = _ref.source;
                        var result = o;
                        var act = source.act, eventid = source.eventid, event_id = source.moreinfo.event_id;
                        var item = null !== (_ref2 = null !== eventid && void 0 !== eventid ? eventid : event_id) && void 0 !== _ref2 ? _ref2 : defaultEventId;
                    ...
                    return "".concat(enhancedUrl, "&_act=").concat(joinStr);
                }));
                null === (_window$HdSdk4 = window.HdSdk) || void 0 === _window$HdSdk4 ? void 0 : _window$HdSdk4.shopTracker.use("request", (function(data) {
                    if ("websdkentmaster" !== data.act) return data;
                    var result = _objectSpread(_objectSpread({}, data), {}, {
                        event_sent_at_ms: data.request_time
                    });
                    delete result.request_time;
                    return result;
                }));
            };
            new HdReport;
    ...
    (() => {
        ...
        try {
            ...
            var options = {
                debug: false,
                environment: APP_ENV,
                release: "".concat(APP_ENV, "@").concat("undefined_theme_Expect_1.0.0_1f486edca"),
